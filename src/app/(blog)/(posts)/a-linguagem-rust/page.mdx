---
postTitle: A linguagem Rust
category: "rust"
categoryImageUrl: './rust-svgrepo-com.svg'
poster: {
  name: 'Clemilson Azevedo',
  imageUrl: 'https://github.com/clemilsonazevedo.png'
}
publishDate: 2024-11-24T11:00:00Z
---
...
<div className="space-y-5">
  <div className='space-y-4'>
    <div>
      <span className='px-3 py-[6px] rounded-[6px] bg-blogYellow text-blogWhite text-sm font-medium leading-5'>rust</span>
    </div>
    # A linguagem Rust
  </div>
