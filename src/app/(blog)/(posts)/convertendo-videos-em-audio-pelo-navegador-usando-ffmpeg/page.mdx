...
> [!INFO] Declarar variáveis
> Vamos focar em declarar uma string que se inicializa vazia.
> ```rust
> 	let name: String = String::new();
> ```

>[!IMPORTANT] Regras de Declaração de variáveis
...
> ```
> 
> Se por acaso precisarmos de redeclarar essa variável podemos usar o ```.clone()``` para pode clonar o valor da variável e poder usar normalmente após a redeclaração.